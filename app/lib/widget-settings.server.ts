...
export const DEFAULT_WIDGET_SETTINGS = {
  ...
  breakdown_caret_size_px: 14,
  show_review_count: true,
  review_count_label: "Reviews",
  heading_weight: 700,
  summary_rating_weight: 700,
  summary_count_weight: 500,
  button_weight: 600,
  reviewer_name_weight: 700,
  title_weight: 650,
  body_weight: 400,
  meta_weight: 500,
  verified_weight: 600,
  breakdown_average_weight: 700,
  modal_title_weight: 700,
  modal_label_weight: 600,
  input_weight: 400,
...
async function ensureWidgetSettingsColumns() {
  await prisma.$executeRawUnsafe(`
    ALTER TABLE "review_widget_settings"
      ...
      ADD COLUMN IF NOT EXISTS "breakdown_caret_size_px" INTEGER NOT NULL DEFAULT 14,
      ...
      ADD COLUMN IF NOT EXISTS "heading_weight" INTEGER NOT NULL DEFAULT 700,
      ADD COLUMN IF NOT EXISTS "summary_rating_weight" INTEGER NOT NULL DEFAULT 700,
      ADD COLUMN IF NOT EXISTS "summary_count_weight" INTEGER NOT NULL DEFAULT 500,
      ADD COLUMN IF NOT EXISTS "button_weight" INTEGER NOT NULL DEFAULT 600,
      ADD COLUMN IF NOT EXISTS "reviewer_name_weight" INTEGER NOT NULL DEFAULT 700,
      ADD COLUMN IF NOT EXISTS "title_weight" INTEGER NOT NULL DEFAULT 650,
      ADD COLUMN IF NOT EXISTS "body_weight" INTEGER NOT NULL DEFAULT 400,
      ADD COLUMN IF NOT EXISTS "meta_weight" INTEGER NOT NULL DEFAULT 500,
      ADD COLUMN IF NOT EXISTS "verified_weight" INTEGER NOT NULL DEFAULT 600,
      ADD COLUMN IF NOT EXISTS "breakdown_average_weight" INTEGER NOT NULL DEFAULT 700,
      ADD COLUMN IF NOT EXISTS "modal_title_weight" INTEGER NOT NULL DEFAULT 700,
      ADD COLUMN IF NOT EXISTS "modal_label_weight" INTEGER NOT NULL DEFAULT 600,
      ADD COLUMN IF NOT EXISTS "input_weight" INTEGER NOT NULL DEFAULT 400,
...
export async function upsertWidgetSettings(shopId: string, input: Partial<typeof DEFAULT_WIDGET_SETTINGS>) {
  ...
  if (delegate?.upsert) {
    try {
      ...
      if (!msg.includes("Unknown argument") && !msg.includes("section_heading") && !msg.includes("empty_state_text") && !msg.includes("verified_badge_label") && !msg.includes("verified_badge_color") && !msg.includes("verified_badge_text_color") && !msg.includes("summary_star_size_px") && !msg.includes("summary_text_size_px") && !msg.includes("write_review_btn_font_size_px") && !msg.includes("breakdown_caret_size_px") && !msg.includes("show_review_count") && !msg.includes("review_count_label") && !msg.includes("heading_weight") && !msg.includes("summary_rating_weight") && !msg.includes("summary_count_weight") && !msg.includes("button_weight") && !msg.includes("reviewer_name_weight") && !msg.includes("title_weight") && !msg.includes("body_weight") && !msg.includes("meta_weight") && !msg.includes("verified_weight") && !msg.includes("breakdown_average_weight") && !msg.includes("modal_title_weight") && !msg.includes("modal_label_weight") && !msg.includes("input_weight") && !msg.includes("modal_") && !msg.includes("initial_reviews_limit") && !msg.includes("load_more_step") && !msg.includes("load_more_label") && !msg.includes("default_sort_mode")) {
        throw error;
      }
    }
  }
  ...
  try {
    const rows = await prisma.$queryRawUnsafe<any[]>(
      `INSERT INTO "review_widget_settings" (
        ...
        verified_badge_color, verified_badge_text_color, summary_star_size_px, summary_text_size_px, write_review_btn_font_size_px, breakdown_caret_size_px, show_review_count, review_count_label,
        heading_weight, summary_rating_weight, summary_count_weight, button_weight, reviewer_name_weight, title_weight, body_weight, meta_weight, verified_weight, breakdown_average_weight, modal_title_weight, modal_label_weight, input_weight,
      ...
      ON CONFLICT (shop_id) DO UPDATE SET
        ...
        breakdown_caret_size_px = EXCLUDED.breakdown_caret_size_px,
        ...
        summary_rating_weight = EXCLUDED.summary_rating_weight,
        summary_count_weight = EXCLUDED.summary_count_weight,
        button_weight = EXCLUDED.button_weight,
        reviewer_name_weight = EXCLUDED.reviewer_name_weight,
        title_weight = EXCLUDED.title_weight,
        body_weight = EXCLUDED.body_weight,
        meta_weight = EXCLUDED.meta_weight,
        verified_weight = EXCLUDED.verified_weight,
        breakdown_average_weight = EXCLUDED.breakdown_average_weight,
        modal_title_weight = EXCLUDED.modal_title_weight,
        modal_label_weight = EXCLUDED.modal_label_weight,
        input_weight = EXCLUDED.input_weight,
      ...
      merged.breakdown_caret_size_px,
      merged.show_review_count,
      merged.review_count_label,
      merged.heading_weight,
      merged.summary_rating_weight,
      merged.summary_count_weight,
      merged.button_weight,
      merged.reviewer_name_weight,
      merged.title_weight,
      merged.body_weight,
      merged.meta_weight,
      merged.verified_weight,
      merged.breakdown_average_weight,
      merged.modal_title_weight,
      merged.modal_label_weight,
      merged.input_weight,
      merged.modal_title,
