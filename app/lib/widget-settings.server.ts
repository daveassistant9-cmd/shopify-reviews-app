...
export const DEFAULT_WIDGET_SETTINGS = {
  ...
  write_review_label: "Értékelés írása",
  section_heading: "Vásárlói vélemények",
  empty_state_text: "Még nincsenek értékelések",
  verified_badge_label: "Ellenőrzött",
  ...
  input_weight: 400,
  modal_title: "Írj értékelést",
  modal_subtitle: "Oszd meg a tapasztalatod erről a termékről",
  modal_name_label: "Neved",
  modal_rating_label: "Értékelés",
  modal_review_title_label: "Értékelés címe",
  modal_review_body_label: "Vélemény",
  modal_image_label: "Képek (opcionális)",
  modal_submit_label: "Értékelés beküldése",
  modal_success_message: "Köszönjük! Értékelésedet elküldted, moderálás után jelenik meg.",
  modal_error_message: "Nem sikerült elküldeni az értékelést",
  modal_close_label: "Bezárás",
  modal_image_helper_text: "Legfeljebb 5 képet tölthetsz fel",
  initial_reviews_limit: 20,
  load_more_step: 20,
  load_more_label: "További értékelések",
